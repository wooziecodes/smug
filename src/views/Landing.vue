<template>
            ...
            <div class="header-hero-content text-center">
              <kinesis-container>
                <kinesis-element :strength="50">
                  ...
                  <h3 class="header-sub-title mt-6" style="color:black; text-align: center; margin-top: 70px;">
  ...
  <p v-if="show">hello</p>
   ...
   -->
        ...
        <div class="row-mt-6">
          <div class="col-lg-12">
            <div class="header-hero-image text-center animate__fadeIn" data-wow-duration="1.3s" data-wow-delay="1.4s">

              <img :src="require('../assets/images/hero1.png')" />
...
import Features from './TheFeatures.vue'
import Footer from './TheFooter.vue'
import Testimonials from './TheTestimonials.vue'
...
export default {
  ...
  mounted() {
    // Sticky header
    $(window).on('scroll', () => {
      this.scrolled = $(window).scrollTop() > 600
    })
  },
  ...
  props: {
    img: {
      type: String,
      default: require('../assets/images/hero1.png')
    }
...
.preloader .loader .ytp-spinner-circle {
  ...
  border-style: solid;
  /* Spinner Color */
  border-color: #1F5C64 #1F5C64 #E1E1E1;
  border-radius: 50%;
  border-width: 6px;
}
...
.counter-wrapper .single-counter.counter-color-3::before {
  background: -webkit-linear-gradient(#1F5C64 0%, #2e82ef 100%);
  background: -o-linear-gradient(#1F5C64 0%, #2e82ef 100%);
  background: linear-gradient(#1F5C64 0%, #2e82ef 100%);
}
...
.back-to-top {
  ...
  line-height: 40px;
  border-radius: 5px;
  background: -webkit-linear-gradient(left, #1F5C64 0%, #2e82ef 100%);
  background: -o-linear-gradient(left, #1F5C64 0%, #2e82ef 100%);
  background: linear-gradient(to right, #1F5C64 0%, #2e82ef 100%);
  text-align: center;
  z-index: 99;
  -webkit-transition: all 0.3s ease-out 0s;
  -moz-transition: all 0.3s ease-out 0s;
